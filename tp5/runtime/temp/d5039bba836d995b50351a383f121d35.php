<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\htdocs\tp5\public/../application/admin\view\conf\index.html";i:1547778528;s:55:"D:\htdocs\tp5\application\admin\view\public\layout.html";i:1547827523;}*/ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="col-md-10">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <button class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span><a href="<?php echo url('add'); ?>" style="color:white">&nbsp;&nbsp;添加配置</a></button>
