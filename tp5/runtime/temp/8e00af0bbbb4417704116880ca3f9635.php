<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\htdocs\tp5\public/../application/admin\view\auth_group\update.html";i:1547796195;s:55:"D:\htdocs\tp5\application\admin\view\public\layout.html";i:1547827523;}*/ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
        ...
        <form action="<?php echo url('update'); ?>" method="post">
          <div class="form-group">
            ...
            <select  name="title" class="form-control">
              ...
              <option value="<?php echo $mdata['username']; ?>" <?php echo $udata['title']==$mdata['username']?'selected':''; ?>><?php echo $mdata['username']; ?></option>
          ...
          <div class="form-group">
            ...
            <label for="radio-inline">
              <input type="radio" name="status" value="1" <?php echo $udata['status']==1?'checked':''; ?>>正常
            </label>
            <br>
            <label for="radio-inline">
              <input type="radio" name="status" value="0" <?php echo $udata['status']==0?'checked':''; ?>>禁用
            </label>
          </div>
          <div class="form-group">
            <label for="">规则</label>
