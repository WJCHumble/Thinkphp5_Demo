<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\htdocs\tp5\public/../application/admin\view\article\add.html";i:1547657797;s:55:"D:\htdocs\tp5\application\admin\view\public\layout.html";i:1547827523;}*/ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<script src="/static/admin/baidu/ueditor.config.js" charset="utf-8"></script>
<script src="/static/admin/baidu/ueditor.all.min.js" charset="utf-8"></script>
<script src="/static/admin/baidu/lang/zh-cn/zh-cn.js" charset="utf-8"></script>
<div class="col-md-10">
	<ol class="breadcrumb">
	...
	<div class="panel panel-default">
        ...
        <form action="<?php echo url('add'); ?>" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" name="des" class="form-control" id="" value="">
          </div>
          <div class="form-group">
            <label for="">文章关键字</label>
            <input type="text" name="keywords" class="form-control" id="" value="">
          </div>
          <div class="form-group">
  ...
  $(function() {
    $('#file_upload').uploadify({
      ...
      onUploadSuccess:function(file, data, response){
        img="<img src='/static/uploads/article/"+data+"' alert='' width='200px' height='80px'>";
        $("#queue").html(img);
        $('#addImg').val(data);
      }
    });
