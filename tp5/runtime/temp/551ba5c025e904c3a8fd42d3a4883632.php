<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\htdocs\tp5\public/../application/admin\view\auth_rule\index.html";i:1547782608;s:55:"D:\htdocs\tp5\application\admin\view\public\layout.html";i:1547827523;}*/ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="col-md-10">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <button class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span><a href="<?php echo url('add'); ?>" style="color:white">&nbsp;&nbsp;添加规则</a></button>
        ...
        <div class="panel-body">
            <table class="table table-bordered table-hover">
                ...
                <?php if(is_array($authtree) || $authtree instanceof \think\Collection || $authtree instanceof \think\Paginator): $i = 0; $__LIST__ = $authtree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dat): $mod = ($i % 2 );++$i;?>
                <tr id="tr<?php echo $dat['id']; ?>">
                  ...
                  <td><?php echo $dat['level']; ?>级别</td>
                  <td><input type="text" name="" id="sort" value="<?php echo $dat['sort']; ?>"  onblur="sort(this, <?php echo $dat['id']; ?>)"></td>
                  <td>
