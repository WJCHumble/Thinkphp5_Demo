<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"D:\htdocs\tp5\public/../application/admin\view\article\index.html";i:1547657631;s:55:"D:\htdocs\tp5\application\admin\view\public\layout.html";i:1547827523;}*/ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
        ...
        <div class="panel-body">
            <table class="table table-bordered table-hover">
                ...
                <tr id="tr<?php echo $dat['id']; ?>">
                    ...
                    <td><img src="/static/uploads/article/<?php echo $dat['img']; ?>" alt="" class="img-resposive" width="80px" height="50px"></td>
                    <td><?php echo $dat['authorname']; ?></td>
                    <td><?php echo $dat['columname']; ?></td>
                    <td>
