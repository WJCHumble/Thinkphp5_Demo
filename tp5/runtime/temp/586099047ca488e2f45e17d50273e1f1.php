<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\htdocs\tp5\public/../application/admin\view\auth_rule\update.html";i:1547781580;s:55:"D:\htdocs\tp5\application\admin\view\public\layout.html";i:1547827523;}*/ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
        ...
        <form action="<?php echo url('update'); ?>" method="post">
          <div class="form-group">
            ...
            <select  name="pid" class="form-control">
              ...
              <option value="<?php echo $rule['id']; ?>" <?php echo $rule['id']==$data['pid']?'selected':''; ?>>
                <?php
                if($rule['level']!=0){
                  echo '-';
                }
          ...
          <div class="form-group">
            ...
            <input type="text" name="title" class="form-control" id="" value="<?php echo $data['title']; ?>">
          </div>
          <div class="form-group">
            <label for="">控/方</label>
